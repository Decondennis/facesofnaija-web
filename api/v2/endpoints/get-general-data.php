    ...
    if (!empty($data['notifications'])) {
        ...
        foreach ($notifications as $notification) {
            ...
            if (!empty($wo['notification']['type'])) {
                ...
                if ($wo['notification']['type'] == 'accepted_community_join_request') {
                    $community_id                        = @end(explode('/', $wo['notification']['url']));
                    $community                           = Wo_CommunityData(Wo_CommunityIdFromCommunityname($community_id));
                    $wo['notification']['type_text'] = str_replace('{community_name}', $community['name'], $wo['lang']['accepted_community_join_request']);
                    $wo['notification']['icon'] .= 'user-plus';
                }
                ...
                if ($wo['notification']['type'] == 'community_moderator') {
                    $wo['notification']['type_text'] = $wo['lang']['added_community_moderator'];
                    $wo['notification']['icon']     .= 'community_moderator';
                }
