...
$required_fields =  array(
                        ...
                        'get_user_posts',
                        'get_group_posts',
                        'get_community_posts',//added this
                        'get_page_posts',
                        'get_event_posts',
                        'share_post_on_timeline',
                        'share_post_on_page',
                        'share_post_on_group',
                        'share_post_on_community',//added this
                        'saved',
                        'hashtag',
                        'get_random_groups',
                        'get_random_communities',//added this
                        'get_random_pages',
                        'get_random_videos'
                    );
...
if (!empty($_POST['type']) && in_array($_POST['type'], $required_fields)) {
	if ($_POST['type'] != 'get_news_feed' && $_POST['type'] != 'saved' && $_POST['type'] != 'hashtag' && $_POST['type'] != 'get_random_groups' && $_POST['type'] != 'get_random_communities' && $_POST['type'] != 'get_random_pages' && $_POST['type'] != 'get_random_videos') {
	...
	if (empty($error_code)) {
		...
		//added this
		if ($_POST['type'] == 'get_community_posts') {
			$community_id = Wo_Secure($_POST['id']);
