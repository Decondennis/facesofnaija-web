...
if ($f == 'posts') {
    ...
    if ($s == 'insert_new_post') {
        ...
        } else if (isset($_POST['community_id']) && !empty($_POST['community_id'])) { //added this
        ...
        if (empty($errors) && $invalid_file == false) {
            ...
            $post_data                = array(
                ...
                'community_id' => Wo_Secure($community_id), //added this
            ...
            if ($wo['config']['notify_new_post'] == 1) {
                if (!empty($wo['story']) && empty($wo['story']['page_id']) && empty($wo['story']['group_id']) && empty($wo['story']['community_id']) && empty($wo['story']['event_id']) && $wo['story']['postPrivacy'] < 3) {
        ...
        if (!empty($id)) {
            ...
            if ($wo['config']['post_approval'] == 1 && !Wo_IsAdmin()) {
                ...
                if ($wo['config']['notify_new_post'] == 1) {
                    if (empty($wo['story']['page_id']) && empty($wo['story']['group_id']) && empty($wo['story']['community_id']) && empty($wo['story']['event_id']) && $wo['story']['postPrivacy'] < 3) {
    ...
    if ($s == 'load_more_posts') {
        ...
        if (!empty($_GET['filter_by_more']) && $_GET['filter_by_more'] == 'story' && isset($_GET['story_id']) && isset($_GET['user_id'])) {
            ...
            if (!empty($_GET['community_id']) && $_GET['community_id'] > 0) { //added this
    ...
    if ($s == 'filter_posts') {
        if (!empty($_GET['filter_by']) && isset($_GET['id'])) {
            ...
            if (!empty($_GET['type'])) {
                ...
                } else if ($_GET['type'] == 'community') { //added this
                    $options['community_id'] = $_GET['id'];
